...
<Item type="CWeaponInfo">
  ...
  <Audio>AUDIO_ITEM_VEHICLE_WEAPON_FLAMETHROWER</Audio>
  <Slot>SLOT_RAYMINIGUN</Slot>
  <DamageType>BULLET</DamageType>
  <FireType>VOLUMETRIC_PARTICLE</FireType>
  <Damage value="175.000000" />
  ...
  <Fx>
    ...
    <FlashFx>muz_xs_turret_flamethrower_looping</FlashFx>
    <FlashFxAlt />
    <FlashFxFP />
    <FlashFxFPAlt />
    <MuzzleSmokeFx />
...
<Item type="CWeaponInfo">
  <Name>WEAPON_MICROSMG</Name>
  <Damage value="25.000000" />
  <VehicleReloadTime value="0.50000" />
  ...
  <AttachPoints>
    ...
    <Item>
      ...
      <Components>
        ...
        <Item>
          <Name>COMPONENT_AT_SIGHTS_SMG</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_AT_SCOPE_MACRO_02_SMG_MK2</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_AT_SCOPE_SMALL_SMG_MK2</Name>
          <Default value="true" />
        </Item>
      </Components>
    </Item>
    ...
    <Item>
      ...
      <Components>
        <Item>
          <Name>COMPONENT_MICROSMG_VARMOD_XM3</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MICROSMG_VARMOD_FRN</Name>
          <Default value="true" />
        </Item>				
      </Components>
    </Item>
  </AttachPoints>
  <WeaponFlags>ArmourPenetrating CarriedInHand Automatic Gun CanLockonOnFoot CanLockonInVehicle CanFreeAim AnimReload AnimCrouchFire TreatAsOneHandedInCover UsableOnFoot UsableInCover AllowEarlyExitFromFireAnimAfterBulletFired NoLeftHandIKWhenBlocked AllowCloseQuarterKills HasLowCoverReloads HasLowCoverSwaps UseLeftHandIkWhenAiming QuitTransitionToIdleIntroOnWeaponChange DisableLeftHandIkWhenOnFoot UseFPSAimIK UseFPSSecondaryMotion UseAlternateFPDrivebyClipset FPSOnlyExitFireAnimAfterRecoilEnds</WeaponFlags>
</Item>
<Item type="CWeaponInfo">
  <Name>WEAPON_HEAVYSNIPER_MK2</Name>
  <Model>w_sr_heavysniper</Model>
  <Damage value="250.000000" />
  <AnimReloadRate value="1.500000" />
  <WeaponFlags>ArmourPenetrating CarriedInHand FirstPersonScope Gun CanFreeAim TwoHanded AnimReload AnimCrouchFire UsableOnFoot UsableInCover HasLowCoverReloads HasLowCoverSwaps IgnoreHelmets DriveByMPOnly UseFPSAimIK DisableFPSAimForScope UseFPSSecondaryMotion IncendiaryGuaranteedChance</WeaponFlags>
</Item>
<Item type="CWeaponInfo">
  ...
  <AttachPoints>
    ...
    <Item>
      ...
      <Components>
        ...
        <Item>
          <Name>COMPONENT_CARBINERIFLE_VARMOD_MICH</Name>
          <Default value="false" />
        </Item>				
      </Components>
    </Item>
    <Item>
      <AttachBone>gun_gripr</AttachBone>
      <Components>
        <Item>
...
<Item type="CWeaponInfo">
  ...
  <VehicleDamageModifier value="13.00000" />
...
<Item type="CWeaponInfo">
  <Name>WEAPON_MARKSMANRIFLE_MK2</Name>
  <AttachPoints>
    <Item>
      <AttachBone>WAPClip</AttachBone>
      <Components>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CLIP_01</Name>
          <Default value="false" />
        </Item>
        <Item>
        ...
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CLIP_ARMORPIERCING</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CLIP_FMJ</Name>
          <Default value="false" />
        </Item>
        <Item>
        ...
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CLIP_TRACER</Name>
          <Default value="false" />
        </Item>
      </Components>
    </Item>
    ...
    <Item>
      ...
      <Components>
        <Item>
          <Name>COMPONENT_AT_MRFL_BARREL_01</Name>
          <Default value="true" />
        </Item>
        <Item>
          <Name>COMPONENT_AT_MRFL_BARREL_02</Name>
          <Default value="false" />
        </Item>
      </Components>
    </Item>
    <Item>
      ...
      <Components>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_02</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_03</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_04</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_05</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_06</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_07</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_08</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_09</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_10</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_MARKSMANRIFLE_MK2_CAMO_IND_01</Name>
          <Default value="false" />
        </Item>
      </Components>
    </Item>
  </AttachPoints>
  <WeaponFlags>IncendiaryGuaranteedChance ArmourPenetrating CarriedInHand Automatic ApplyBulletForce Gun CanLockonOnFoot CanFreeAim TwoHanded AnimReload AnimCrouchFire UsableOnFoot UsableInCover AllowEarlyExitFromFireAnimAfterBulletFired NoLeftHandIKWhenBlocked HasLowCoverReloads HasLowCoverSwaps TorsoIKForWeaponBlock LongWeapon AllowMovementDuringFirstPersonScope DriveByMPOnly UseFPSAimIK DisableFPSAimForScope UseFPSSecondaryMotion FPSOnlyExitFireAnimAfterRecoilEnds</WeaponFlags>
</Item>
<Item type="CWeaponInfo">
  ...
  <IkRecoilDisplacementScaleBackward value="0.0" />
  <IkRecoilDisplacementScaleVertical value="0.0" />
  <AttachPoints>
    <Item>
      <AttachBone>WAPClip</AttachBone>
      <Components>
...
<Item type="CWeaponInfo">
  ...
  <ExplosionShakeAmplitude value="0.033300" />
  <AttachPoints>
    <Item>
      <AttachBone>WAPClip</AttachBone>
      <Components>
...
<Item type="CAmmoProjectileInfo">
  ...
  <Explosion>
    <Default>SMOKEGRENADELAUNCHER</Default>
    <HitCar>DONTCARE</HitCar>
    <HitTruck>DONTCARE</HitTruck>
    <HitBike>DONTCARE</HitBike>
    <HitBoat>DONTCARE</HitBoat>
...
<Item type="CAmmoProjectileInfo">
  ...
  <Explosion>
    <Default>EMPLAUNCHER_EMP</Default>
    <HitCar>DONTCARE</HitCar>
    <HitTruck>DONTCARE</HitTruck>
    <HitBike>DONTCARE</HitBike>
    <HitBoat>DONTCARE</HitBoat>
  ...
  <LifeTimeAfterImpact value="180.000000" />
  <LifeTimeAfterExplosion value="0.000000" />
  <ExplosionTime value="15.000000" />
  <LaunchSpeed value="2000.000000" />
  ...
  <ClusterExplosionCount value="1" />
  <ClusterMinRadius value="0.100000" />
  <ClusterMaxRadius value="0.100000" />
  <ClusterInitialDelay value="0.010000" />
  <ClusterInbetweenDelay value="0.010000" />
  <ProjectileFlags>Sticky NoPullPin ProcessImpacts CanBeDestroyedByDamage</ProjectileFlags>
</Item>
<Item type="CWeaponInfo">
  <Name>WEAPON_EMPLAUNCHER</Name>
  <Speed value="2000.000000" />
  <Damage value="0.000000" />
  <LightlyArmouredDamageModifier value="0.010000" />
  <NetworkPlayerDamageModifier value="0.010000" />
  <NetworkPedDamageModifier value="0.010000" />
  <VehicleDamageModifier value="0.01000" />
  <AnimReloadRate value="1.500000" />
  <WeaponRange value="1000.000000" />
  <WeaponFlags>ManualDetonation CarriedInHand Gun CanFreeAim Launched AnimReload AnimCrouchFire UsableOnFoot UsableInCover AllowCloseQuarterKills HasLowCoverReloads HasLowCoverSwaps DelayedFiringAfterAutoSwap UseFPSAimIK UseFPSSecondaryMotion DontPlayDryFireAnim</WeaponFlags>
</Item>
]]